...
describe('CardDetailModal', () => {
  ...
  it('displays the card name and meaning', () => {
    render(<CardDetailModal card={mockCard} onClose={() => {}} />);
  ...
  it('calls onClose when close button is clicked', () => {
    const onClose = vi.fn();
    render(<CardDetailModal card={mockCard} onClose={onClose} />);
  ...
  it('calls onClose when backdrop is clicked', () => {
    const onClose = vi.fn();
    const { container } = render(<CardDetailModal card={mockCard} onClose={onClose} />);
